#
# Be sure to run `pod lib lint WYAImageScroll.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'WYATeam' => 'lsh' }
  s.source           = { :git => 'https://github.com/CreatSuns/WYAScrollKit.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'WYAImageScroll/Classes/**/*'
  
  s.static_framework = true
  
   s.resource_bundles = {
     'WYAImageScroll' => ['WYAImageScroll/Assets/*.xcassets']
   }
